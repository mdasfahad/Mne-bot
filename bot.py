...
TOKEN = os.environ.get("BOT_TOKEN", "8603057367:AAG2uF_wENaVCPLgx1EOjQJoFcz1DfjkxT8")
if not TOKEN:
    raise ValueError("❌ BOT_TOKEN environment variable not set!")

OWNER_ID = int(os.environ.get("OWNER_ID", "8289191009"))
ADMIN_ID = int(os.environ.get("ADMIN_ID", "8289191009"))
YOUR_USERNAME = os.environ.get("YOUR_USERNAME", "@sabbir2850")
UPDATE_CHANNEL = os.environ.get("UPDATE_CHANNEL", "https://t.me/FreeIncome_TechBD")
